    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si es necesario, puede cerrar sesión en todos sus otros navegadores y dispositivos. Algunas sesiones recientes se muestran abajo; la lista puede no ser exhaustiva. Si cree que su cuenta fue comprometida, también debe actualizar su contraseña.
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Ingrese su contraseña para confirmar que desea cerrar sesión en sus otros navegadores y dispositivos.
