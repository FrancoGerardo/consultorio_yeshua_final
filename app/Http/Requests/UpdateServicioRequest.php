...
class UpdateServicioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tipo_sala_requerido' => 'nullable|string|in:CONSULTORIO,LABORATORIO,RAYOS_X,QUIROFANO,EMERGENCIA,UCI',
    ...
    public function messages(): array
    {
        return [
            ...
            'tipo_sala_requerido.in' => 'El tipo de sala seleccionado no es válido.',
